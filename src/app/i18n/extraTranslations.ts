...
export const extraTranslations: Record<Language, Record<string, string>> = {
  sq: {
    ...
    'settings.waBody':
      'Lidh WhatsApp një herë. Pastaj, kur dikush rezervon, konfirmimi i shkon vetë — ti s’e hap.',
    ...
    'appointment.waReady': 'Konfirmimi u ruajt. WhatsApp s’u lidh ende për dërgim automatik.',
    'appointment.waOpen': 'Hap WhatsApp (backup)',
  ...
  en: {
    ...
    'settings.waTitle': 'WhatsApp (iOS & Android)',
    'settings.waBody':
      'Connect WhatsApp once. After that, booking confirmations send by themselves.',
    ...
    'appointment.waReady': 'Saved. WhatsApp is not connected for automatic send yet.',
    'appointment.waOpen': 'Open WhatsApp (backup)',
  ...
  sr: {
    ...
    'settings.waTitle': 'WhatsApp (iOS & Android)',
    'settings.waBody':
      'Poveži WhatsApp jednom. Posle toga potvrde termina stižu same — ne otvaraš WhatsApp.',
    ...
    'appointment.waReady': 'Otvorite potvrdu na WhatsApp-u — to je vaš dokaz, bez emaila.',
    'appointment.waOpen': 'Otvori WhatsApp',
