...
export const extraTranslations: Record<Language, Record<string, string>> = {
  sq: {
    ...
    'voice.unsupported': 'Shfletuesi juaj nuk e mbështet mikrofonin. Përdorni Chrome.',
  ...
  en: {
    ...
    'voice.unsupported': 'Your browser does not support the microphone. Use Chrome.',
  ...
  sr: {
    ...
    'voice.unsupported': 'Pregledač ne podržava mikrofon. Koristite Chrome.',
